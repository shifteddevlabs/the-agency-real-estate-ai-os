...
The architectural choices that shape The Agency. The five load-bearing decisions come first because they are the most consequential. The compliance and scope choices follow. Reused patterns are documented at the bottom for traceability.
