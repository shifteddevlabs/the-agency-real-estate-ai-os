...
The second design decision is shared process, specialist-owned signals. The Deal Desk, handoff contract, lead/deal log, and Agency Standard live once in `support/reference/`. Each specialist only owns the signals it contributes, such as lead temperature, source recheck, draft status, or verified deadline.
