...
- When the user asks what needs attention today, asks for active work, or pastes multiple lead/deal logs, use `support/reference/daily-operating-brief.md`.
...
- `support/reference/daily-operating-brief.md`: use when summarizing several leads/deals, creating a daily brief, or finding stale work.
